...
.controller('MercenariesCtrl', ['$scope', '$stateParams', '$state', '$ionicLoading', '$rootScope', '$ionicPlatform', '$ionicPopup', '$ionicScrollDelegate', '$timeout', 'User', 'KoC',

function($scope, $stateParams, $state, $ionicLoading, $rootScope, $ionicPlatform, $ionicPopup, $ionicScrollDelegate, $timeout, User, KoC) {

  console.log("MercenariesCtrl");
  ...
  var hire = function(turing, inputNameValue, successMessage, actionMessage) {
    ...
    KoC.hireMercenaries($scope.mercenaries.turing,inputNameValue).success(function(response) {
      if (response.success === true) {
        ...
        recalcBuyTotal();
        console.log("retrieved the mercenaries");
      }
      else {
  ...
  $scope.hireMercs = function() {
    ...
    console.log("hiring mercenaries!", $scope.mercenaries.turing, inputNameValue);
  ...
  $scope.reloadMercenaries = function(cacheTimeInSeconds) {
    console.log("load the mercenaries, cacheTimeInSeconds=" + cacheTimeInSeconds);
    $scope.mercsError = "";
    $scope.disableActions = true;
